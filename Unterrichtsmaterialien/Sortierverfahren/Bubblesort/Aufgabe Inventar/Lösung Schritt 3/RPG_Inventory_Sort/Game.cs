    ...
    class Game
    {
        ...
        private static void DisplayInventory(int inventorySlot = -1)
        {
            ...
            if(inventorySlot == -1)
            {
                ...
                Console.WriteLine("Drücke:  s(Sortieren)    ds(DoubleSort)    1-100(Anzeigen des jew. Item im Slot)  q(Inventar schließen)");
        ...
        {           
            Sorter.DoubleSort(myInventory.GetInventoryItems(), "Name","Haltbarkeit");
            DisplayInventory();
        }
