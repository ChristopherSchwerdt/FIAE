namespace RPG_Inventory_Sort
{
   internal static class Sorter
    {
        public static void DoubleSort(List<InventoryItem> inventory, string firstcriteria, string secondcriteria)
        {
            BubbleSort(inventory, firstcriteria);
            BubbleSort(inventory, secondcriteria);
        }
